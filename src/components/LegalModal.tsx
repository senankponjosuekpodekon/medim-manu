...
export const LegalModal: React.FC<LegalModalProps> = ({ type, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 animate-fadeIn">
      <div className="bg-card border border-gold rounded-3xl p-6 sm:p-8 max-w-2xl w-full shadow-2xl relative space-y-6 max-h-[85vh] overflow-y-auto">
        ...
        {type === 'legalNotice' && (
          <div className="space-y-4 text-xs text-soft leading-relaxed">
            ...
            <div className="space-y-3 bg-base p-5 rounded-2xl border border-soft">
              ...
              <p><strong>Contact Officiel :</strong> contact@medium-manu.com / WhatsApp Officiel indiqué sur le site.</p>
        ...
        <div className="pt-2 text-right">
          <button
            onClick={onClose}
            className="px-5 py-2.5 rounded-xl bg-gold text-main font-bold text-xs"
          >
            J'ai Compris
          </button>
        </div>
