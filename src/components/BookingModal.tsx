...
Bonjour Medium Manu, je souhaite réserver ma consultation privée selon ces modalités.`;
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 animate-fadeIn">
      <div className="bg-[#0F261F] border border-[#C5A059]/40 rounded-3xl p-6 sm:p-8 max-w-xl w-full shadow-2xl relative space-y-6 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#08120F] border border-slate-700 focus:border-[#C5A059] rounded-xl pl-9 pr-3 py-2.5 text-xs text-white focus:outline-none"
                />
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-[#08120F] border border-slate-700 focus:border-[#C5A059] rounded-xl px-3 py-2.5 text-xs text-white focus:outline-none"
              >
          ...
          <div className="p-3 rounded-xl bg-[#08120F] border border border-amber-900/30 text-[11px] text-amber-200/90 flex items-center gap-2">
          ...
          <button
            type="submit"
            className="w-full py-4 rounded-xl bg-gradient-to-r from-[#25D366] to-[#128C7E] text-white font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 shadow-xl hover:scale-[1.02] transition-all"
          >
